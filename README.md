...
- **Creates bind terms, not a submission deadline.** Recent-blockhash txs expire in ~150 slots, but a durable-nonce tx or pending multisig/smart-wallet proposal stays valid until advanced or cancelled, creating state long after signing. The rest of this section follows from that.
